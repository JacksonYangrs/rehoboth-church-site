  ...
  return (
    <main className="site">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-mark hero-photo" aria-hidden="true"><img src="/church-hero.png" alt="清晨教堂中的圣经与烛光" /><div className="hero-photo-shade"></div><p>神在这里<br />为我们开了宽阔之地</p></div>
      ...
      <section className="section study" id="bible-study"><div className="study-box"><div className="study-date"><b>每周五</b><span>7:30 PM</span></div><div><p className="label">BIBLE STUDY NOTICE</p><h2>每周查经公告</h2><p>本周五，我们继续在线上一起查考圣经。欢迎提前阅读经文，带着问题和期待参加 Zoom 查经。</p><div className="study-meta"><span>本周主题：约翰福音中的生命</span><span>形式：Zoom 同步</span></div></div><div className="study-photo" role="img" aria-label="打开的圣经和窗边烛光"></div><a className="btn dark" href="#bible-study">查看公告 →</a></div></section>
